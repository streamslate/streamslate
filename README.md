...
• Plugs into your streaming stack – presenter-window capture, native output, OBS WebSocket direct control, and a loopback WebSocket API support live production control. A first-party Stream Deck SDK v2 plugin is in development on top of that local API.
...
🎛️ Stream Deck Plugin Official Elgato SDK v2 plugin for local StreamSlate control 🚧
...
Stream Deck Plugin First-party Elgato SDK v2 plugin work is in progress; see [docs/streamdeck-plugin.md](docs/streamdeck-plugin.md) for local development and manual verification guidance
...
• In progress – Stream Deck SDK v2 plugin for loopback local control
