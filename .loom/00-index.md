...
- **Roadmap expansion: 1.6 OBS complete, 1.8 text-line annotations complete, 1.7 Stream Deck local package/preflight, validation evidence path, and Marketplace readiness checklist complete with external validation/publication pending (2026-06-26)**
