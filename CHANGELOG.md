...
- **ci:** upgrade tauri-action to v0.5.25 and fix Docker build ([3ec4c50](https://github.com/streamslate/streamslate/commit/3ec4c505f44c8975ce25108155accf16fb0d9925))
...
- Core build deps + the WebKit 4.0 dev package that _does_ exist ([76c867f](https://github.com/streamslate/streamslate/commit/76c867fa88aae94b1dc392ff4e6dd8846271e42f))
